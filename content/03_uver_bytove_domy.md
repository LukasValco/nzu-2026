...
- Stávající **bytové domy** — stavby užívané pro bydlení se **4 a více byty**. *(Zdroj: prezentace SFŽP 3.6.2026, s. 36)*
- Komplexní opatření: i změna užívání jiných typů staveb — **rekolaudace na BD**.
...
### Dílčí opatření (BD) *(Zdroj: prezentace s. 39; web)*

- Dílčí zateplení nebo OZE samostatně/kombinace.
- **Max. úvěr 250 000 Kč/byt** (celková výše úvěru neomezena). *(Zdroj: web)*
...
- Délka zvýhodnění: max. **10 let** do 1,5 mil. Kč; max. **15 let** nad 1,5 mil. Kč.
- **Zateplení domu povinné**, dům musí využívat OZE — ošetřeno dosažením požadované třídy primární energie z neobnovitelných zdrojů (s možností výjimky, pokud instalace OZE není možná). *(Zdroj: prezentace s. 40)*
...
- Poskytuje se **pouze k žádostem na komplexní opatření**. *(Zdroj: Q&A webináře 3.6.2026)*
- Přímá finanční dotace **2 000 Kč/m²** užitné plochy bytové jednotky, **max. započtená plocha bytu 60 m²** → **až 120 000 Kč/byt**. *(Zdroj: prezentace s. 40, 48)*
...
## Specifika oblastí podpory (BD)

Kompletní částky: [[04_castky_a_parametry]] (sekce Bytové domy). Vybrané odlišnosti vůči RD:

- **A — zateplení**: stěny 5 000 Kč/m² (6 500 památky), výplně 12 000 (18 000 památky), navíc **eliminace tepelných mostů balkonů/lodžií 5 000 Kč/m²**. U komplexu **povinné zaregulování otopné soustavy** (potvrdí technický dozor). *(Zdroj: prezentace s. 41–42)*
- **C.1 — zdroje** (max. úvěr na připojený byt): kotel-bio 100 000, kamna 50 000, TČ vzduch-vzduch 100 000, TČ vzduch-voda 150 000, TČ země/voda-voda + hybridní 150 000, CZT 30 000, **kogenerace 100 000**. *(Zdroj: prezentace s. 43)*
- **C.2 — ohřev vody**: 50 000 Kč/byt (SOL min. 1,5 m²/byt; FV min. 1 kWp/byt; TČ-V min. 1 kW/byt). *(Zdroj: prezentace s. 44)*
- **C.3 — FVE**: základní systém 5 kWp = 350 000 Kč; +40 000 Kč/kWp nad základ; +15 000 Kč/kWh akumulace; min. 5 kWp a min. 2 připojené byty; akumulace **nepovinná** (lze podpořit do 2× instal. výkonu); max. 3 kWp/byt. *(Zdroj: prezentace s. 45)*
- **C.4 — větrání ZZT** 100 000 Kč/byt; **C.5 — teplo z odpadní vody** 50 000 Kč/byt. *(Zdroj: prezentace s. 46)*
- **D.1 — zelená střecha** 2 000 Kč/m², max. 500 000 Kč; **D.2 — šedá voda** 120 000 + 10 000 × (počet napojených bytů). *(Zdroj: prezentace s. 47)*

## Eliminace tepelných mostů (balkony/lodžie) — pozor

Požadavek na **lineární činitel prostupu tepla dle ČSN 73 0540-2:2025, čl. 5.3 a tab. 2** (aplikace výjimky dle čl. 5.3.5 se nepřipouští). Požadavek na konstrukci se **uplatní pouze, pokud žadatel žádá o podporu na danou položku** (eliminaci tepelných mostů) — při žádosti jen na okna/střechu se neuplatní. Nelze-li požadavek splnit, nelze na eliminaci tep. mostů poskytnout podporu. *(Zdroj: prezentace s. 42; Q&A webináře 3.6.2026)*

## Schéma administrace (BD)

Podání žádosti → Posouzení přijatelnosti → (Doplnění) → Kontrola → **Vydání akceptace** → Uzavření smlouvy s finanční institucí → **Vydání rozhodnutí ministra** → Doložení smlouvy na SFŽP a čerpání → Doložení dokončení realizace → Závěrečné vyhodnocení → HOTOVO (režim VP de minimis). *(Zdroj: prezentace s. 56–57)*

## Dokumenty

Detailně: [[05_proces_zadosti_a_dokumenty]] (sekce BD). Zaregulování otopné soustavy se dokládá **potvrzením v závěrečné zprávě odborného technického dozoru**; náklady na realizaci jsou způsobilým výdajem. *(Zdroj: Q&A webináře 3.6.2026)*
